...
/**
 * Gera um JWT válido para um usuário com perfil DENUNCIANTE
 */
...
/**
 * Gera um JWT válido para um usuário com perfil GESTOR
 */
...
/**
 * Gera um token inválido / adulterado ou assinado com segredo falso
 */
...
/**
 * Helper para formatar cabeçalho Cookie para supertest
 */
...
/**
 * Helper para formatar cabeçalho Authorization Bearer para supertest
 */
